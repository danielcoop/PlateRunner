...
{
    public class PlateRunnerPackageApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                opt.SwaggerDoc(PackageConstants.ApiName, new OpenApiInfo
                {
                    Title = "Plate Runner Package Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<PlateRunnerPackageOperationSecurityFilter>();
            });
        }

        public class PlateRunnerPackageOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
            protected override string ApiName => PackageConstants.ApiName;
        }
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("PlateRunner.Package.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
